...
<script type="text/javascript"  src="back/manager/ckeditor/ckeditor.js"></sccript>  
   
 <script type="text/javascript">  
 $(function(){
   //页面加载完，查询所有的新闻类别，显示到select 中、
   showNewsType();
  ...
  参数说明： obj:input=file的表单文件对象
           picid:用于像是图片的<img /> 标签id号
           
  */
  function  showUploadImg(obj,picid){
        	  //判断浏览器是否支持Filereader接口 
        	  if( typeof  FileReader=='unfined'){
        		  $.messager.alert('warning','浏览器不支持FileReader接口');
        		  //使选择控件不可操作
